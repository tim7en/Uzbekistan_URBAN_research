...
class SUHIStatisticalAnalyzer:
    ...
    def temporal_trend_analysis(self):
        ...
        print(f"\nREGIONAL TREND ANALYSIS (2016-2024):")
    ...
    def generate_insights_report(self):
        ...
        # Temporal insights
        first_year_mean = self.df[self.df['Year'] == 2016]['SUHI_Day'].mean()
        ...
        insights.append({
            ...
            'insight': f"Decade change (2016-2024): {decade_change:+.2f}°C",
...
def main():
    ...
    analyzer = SUHIStatisticalAnalyzer("scientific_suhi_analysis/data/comprehensive_suhi_analysis_20250813_115209.json")
