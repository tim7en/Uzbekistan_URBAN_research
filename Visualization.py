...
def create_comprehensive_visualizations():
    ...
    # Load data
    with open("scientific_suhi_analysis/data/comprehensive_suhi_analysis_20250813_115209.json", 'r') as f:
        data = json.load(f)
...
"""
    ...
    plt.tight_layout()
    plt.savefig('scientific_suhi_analysis/images/comprehensive_suhi_analysis_results.png', dpi=300, bbox_inches='tight')
    plt.show()
...
"""
    ...
    # Save report
    with open('scientific_suhi_analysis/reports/COMPREHENSIVE_SUHI_ANALYSIS_REPORT.md', 'w', encoding='utf-8') as f:
        f.write(report)
